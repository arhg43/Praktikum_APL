...
#include <cctype> // Untuk menggunakan isalpha()
...
void tambahAkun() {
    ...
    getline(cin, akun.nama); // Gunakan getline untuk dapat mengambil spasi dalam nama
...
string login() {
    ...
    cout << "Masukkan Nama: ";
    cin.ignore(); // Membersihkan buffer dari karakter newline sebelumnya
    getline(cin, input_nama); // Gunakan getline untuk dapat mengambil spasi dalam nama
    cout << "Masukkan NIM: ";
    cin >> input_nim;
...
void tambahProduk() {
    ...
    cin.ignore(); // Membersihkan buffer dari karakter newline sebelumnya
    getline(cin, produk.nama); // Gunakan getline untuk dapat mengambil spasi dalam nama
...
void pesanProduk() {
    ...
    string nama_produk;
    cin.ignore(); // Membersihkan buffer dari karakter newline sebelumnya
    getline(cin, nama_produk); // Gunakan getline untuk dapat mengambil spasi dalam nama
